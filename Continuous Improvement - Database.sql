...
ALTER SEQUENCE planet.agent_agent_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.agent_agent_id_seq TO postgres;
...
ALTER SEQUENCE planet.call_agent_call_agent_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.call_agent_call_agent_id_seq TO postgres;

-- DROP SEQUENCE planet.call_performance_id_seq;

CREATE SEQUENCE planet.call_performance_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 1
...
ALTER SEQUENCE planet.call_performance_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.call_performance_id_seq TO postgres;
...
ALTER SEQUENCE planet.contact_rate_contact_rate_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.contact_rate_contact_rate_id_seq TO postgres;

-- DROP SEQUENCE planet.contact_rate_id_seq;

CREATE SEQUENCE planet.contact_rate_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 573
...
ALTER SEQUENCE planet.contact_rate_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.contact_rate_id_seq TO postgres;
...
ALTER SEQUENCE planet.country_country_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.country_country_id_seq TO postgres;
...
ALTER SEQUENCE planet.date_date_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.date_date_id_seq TO postgres;
...
ALTER SEQUENCE planet.department_department_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.department_department_id_seq TO postgres;
...
ALTER SEQUENCE planet.incoming_tickets_incoming_tickets_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.incoming_tickets_incoming_tickets_id_seq TO postgres;
...
ALTER SEQUENCE planet.language_language_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.language_language_id_seq TO postgres;

-- DROP SEQUENCE planet.outbound_id_seq;

CREATE SEQUENCE planet.outbound_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 3230
...
ALTER SEQUENCE planet.outbound_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.outbound_id_seq TO postgres;
...
ALTER SEQUENCE planet.productivity_productivity_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.productivity_productivity_id_seq TO postgres;
...
ALTER SEQUENCE planet.quality_evaluations_quality_evaluations_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.quality_evaluations_quality_evaluations_id_seq TO postgres;
...
ALTER SEQUENCE planet.repeat_cases_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.repeat_cases_seq TO postgres;
...
ALTER SEQUENCE planet.repeat_rate_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.repeat_rate_id_seq TO postgres;
...
ALTER SEQUENCE planet.repeat_rate_repeat_rate_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.repeat_rate_repeat_rate_id_seq TO postgres;

-- DROP SEQUENCE planet.surveys_sent_id_seq;

CREATE SEQUENCE planet.surveys_sent_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 45293
...
ALTER SEQUENCE planet.surveys_sent_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.surveys_sent_id_seq TO postgres;

-- DROP SEQUENCE planet.surveys_sent_seq;

CREATE SEQUENCE planet.surveys_sent_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 45293
...
ALTER SEQUENCE planet.surveys_sent_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.surveys_sent_seq TO postgres;
...
ALTER SEQUENCE planet.tickets_sla_tickets_sla_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.tickets_sla_tickets_sla_id_seq TO postgres;
...
ALTER SEQUENCE planet.tl_tl_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.tl_tl_id_seq TO postgres;

-- DROP SEQUENCE planet.voc_id_seq;

CREATE SEQUENCE planet.voc_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 7458
...
ALTER SEQUENCE planet.voc_id_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE planet.voc_id_seq TO postgres;
-- planet.call_agent definition
...
CREATE TABLE planet.call_agent (
	...
	CONSTRAINT call_agents_unique UNIQUE (call_agent_id)
);

-- Permissions

ALTER TABLE planet.call_agent OWNER TO postgres;
GRANT ALL ON TABLE planet.call_agent TO postgres;
...
ALTER TABLE planet."date" OWNER TO postgres;
GRANT ALL ON TABLE planet."date" TO postgres;
...
ALTER TABLE planet.department OWNER TO postgres;
GRANT ALL ON TABLE planet.department TO postgres;
...
ALTER TABLE planet.repeat_cases OWNER TO postgres;
GRANT ALL ON TABLE planet.repeat_cases TO postgres;
...
CREATE TABLE planet.surveys_sent (
	surveys_sent_id int4 DEFAULT nextval('planet.surveys_sent_id_seq'::regclass) NOT NULL,
	"Date" date NULL,
	department_id int4 NULL,
	case_number int4 NULL,
...
ALTER TABLE planet.surveys_sent OWNER TO postgres;
GRANT ALL ON TABLE planet.surveys_sent TO postgres;
...
ALTER TABLE planet.tl OWNER TO postgres;
GRANT ALL ON TABLE planet.tl TO postgres;
...
ALTER TABLE planet.transfers OWNER TO postgres;
GRANT ALL ON TABLE planet.transfers TO postgres;
...
CREATE TABLE planet."VoC" (
	"VoC_ID" numeric DEFAULT nextval('planet.voc_id_seq'::regclass) NOT NULL,
	"Date" date NULL,
...
ALTER TABLE planet."VoC" OWNER TO postgres;
GRANT ALL ON TABLE planet."VoC" TO postgres;
...
ALTER TABLE planet.agent OWNER TO postgres;
GRANT ALL ON TABLE planet.agent TO postgres;
...
CREATE TABLE planet.call_performance (
	...
	asa time NULL,
	aht time NULL,
	call_performance_id int4 NULL,
	CONSTRAINT call_performance_date_fk FOREIGN KEY (date_id) REFERENCES planet."date"(date_id)
);

-- Permissions

ALTER TABLE planet.call_performance OWNER TO postgres;
GRANT ALL ON TABLE planet.call_performance TO postgres;
...
ALTER TABLE planet.case_reason OWNER TO postgres;
GRANT ALL ON TABLE planet.case_reason TO postgres;
...
ALTER TABLE planet.contact_rate OWNER TO postgres;
GRANT ALL ON TABLE planet.contact_rate TO postgres;
...
ALTER TABLE planet.incoming_tickets OWNER TO postgres;
GRANT ALL ON TABLE planet.incoming_tickets TO postgres;
...
CREATE TABLE planet.outbounds (
	outbound_id int4 DEFAULT nextval('planet.outbound_id_seq'::regclass) NOT NULL,
	agent_id int4 NULL,
	"Date" date NULL,
...
ALTER TABLE planet.outbounds OWNER TO postgres;
GRANT ALL ON TABLE planet.outbounds TO postgres;
...
ALTER TABLE planet.productivity OWNER TO postgres;
GRANT ALL ON TABLE planet.productivity TO postgres;
...
ALTER TABLE planet.quality_evaluations OWNER TO postgres;
GRANT ALL ON TABLE planet.quality_evaluations TO postgres;
...
ALTER TABLE planet.repeat_rate OWNER TO postgres;
GRANT ALL ON TABLE planet.repeat_rate TO postgres;
...
ALTER TABLE planet.tickets_sla OWNER TO postgres;
GRANT ALL ON TABLE planet.tickets_sla TO postgres;
...
ALTER TABLE planet."AGENTS_Monthly_Outbounds" OWNER TO postgres;
GRANT ALL ON TABLE planet."AGENTS_Monthly_Outbounds" TO postgres;
...
ALTER TABLE planet."AGENTS_Monthly_Productivity" OWNER TO postgres;
GRANT ALL ON TABLE planet."AGENTS_Monthly_Productivity" TO postgres;
...
ALTER TABLE planet."AGENTS_Monthly_Tickets_SLA" OWNER TO postgres;
GRANT ALL ON TABLE planet."AGENTS_Monthly_Tickets_SLA" TO postgres;
...
ALTER TABLE planet."AGENTS_Monthly_call_performance" OWNER TO postgres;
GRANT ALL ON TABLE planet."AGENTS_Monthly_call_performance" TO postgres;
...
ALTER TABLE planet."AGENT_Monthly_RR" OWNER TO postgres;
GRANT ALL ON TABLE planet."AGENT_Monthly_RR" TO postgres;
...
AS SELECT d2."Month_number",
    ...
    count(
        CASE
            WHEN v."NPS" = ANY (ARRAY[9, 10]::numeric[]) THEN 1
            ELSE NULL::integer
    ...
    count(
        CASE
            WHEN v."CSAT_Service" IS NOT NULL AND v."CSAT_Service"::text <> 'NaN'::text AND (v."CSAT_Service" = ANY (ARRAY[4, 5]::numeric[])) THEN 1
            ELSE NULL::integer
        END) AS csat_positive,
    count(
        CASE
            WHEN v."CSAT_Service" IS NOT NULL AND v."CSAT_Service"::text <> 'NaN'::text AND (v."CSAT_Service" = ANY (ARRAY[1, 2]::numeric[])) THEN 1
            ELSE NULL::integer
    ...
    count(
        CASE
            WHEN v."NES" IS NOT NULL AND v."NES"::text <> 'NaN'::text AND (v."NES" = ANY (ARRAY[4, 5]::numeric[])) THEN 1
            ELSE NULL::integer
        END) AS nes_positive,
    count(
        CASE
            WHEN v."NES" IS NOT NULL AND v."NES"::text <> 'NaN'::text AND (v."NES" = ANY (ARRAY[1, 2]::numeric[])) THEN 1
            ELSE NULL::integer
        END) AS nes_negative,
    count(
        CASE
    ...
    count(
        CASE
            WHEN v."CSAT_Product" IS NOT NULL AND v."CSAT_Product"::text <> 'NaN'::text AND (v."CSAT_Product" = ANY (ARRAY[1, 2]::numeric[])) THEN 1
            ELSE NULL::integer
    ...
    round(count(
        CASE
            WHEN v."CSAT_Product" IS NOT NULL AND v."CSAT_Product"::text <> 'NaN'::text AND (v."CSAT_Product" = ANY (ARRAY[4, 5]::numeric[])) THEN 1
            ELSE NULL::integer
        END)::numeric / NULLIF(count(
        CASE
            WHEN v."CSAT_Product" IS NOT NULL AND v."CSAT_Product"::text <> 'NaN'::text THEN 1
...
ALTER TABLE planet."AGENT_Monthly_VoC" OWNER TO postgres;
GRANT ALL ON TABLE planet."AGENT_Monthly_VoC" TO postgres;
...
ALTER TABLE planet."AGENT_monthly_evaluations" OWNER TO postgres;
GRANT ALL ON TABLE planet."AGENT_monthly_evaluations" TO postgres;
...
ALTER TABLE planet."DAILY_RR" OWNER TO postgres;
GRANT ALL ON TABLE planet."DAILY_RR" TO postgres;
...
ALTER TABLE planet."DAILY_VoC_Results" OWNER TO postgres;
GRANT ALL ON TABLE planet."DAILY_VoC_Results" TO postgres;
...
ALTER TABLE planet."DAILY_repeat_cases" OWNER TO postgres;
GRANT ALL ON TABLE planet."DAILY_repeat_cases" TO postgres;
...
ALTER TABLE planet."MONTHLY_Call_performance" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_Call_performance" TO postgres;
...
ALTER TABLE planet."MONTHLY_Evaluations" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_Evaluations" TO postgres;
...
ALTER TABLE planet."MONTHLY_Incoming" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_Incoming" TO postgres;
...
ALTER TABLE planet."MONTHLY_Outbounds" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_Outbounds" TO postgres;
...
ALTER TABLE planet."MONTHLY_Productivity" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_Productivity" TO postgres;
...
ALTER TABLE planet."MONTHLY_RR" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_RR" TO postgres;
...
ALTER TABLE planet."MONTHLY_Tickets_SLA" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_Tickets_SLA" TO postgres;
...
ALTER TABLE planet."MONTHLY_Transfers" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_Transfers" TO postgres;
...
ALTER TABLE planet."MONTHLY_VoC" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_VoC" TO postgres;
...
ALTER TABLE planet."MONTHLY_VoC_PMS" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_VoC_PMS" TO postgres;
...
ALTER TABLE planet."MONTHLY_VoC_Reasons" OWNER TO postgres;
GRANT ALL ON TABLE planet."MONTHLY_VoC_Reasons" TO postgres;
...
ALTER TABLE planet."Productivity_difference" OWNER TO postgres;
GRANT ALL ON TABLE planet."Productivity_difference" TO postgres;
...
ALTER TABLE planet."VOC_PMS" OWNER TO postgres;
GRANT ALL ON TABLE planet."VOC_PMS" TO postgres;
...
ALTER TABLE planet."VOC_Payments" OWNER TO postgres;
GRANT ALL ON TABLE planet."VOC_Payments" TO postgres;
...
ALTER TABLE planet."VoC_PMS_Negative" OWNER TO postgres;
GRANT ALL ON TABLE planet."VoC_PMS_Negative" TO postgres;
...
ALTER TABLE planet."VoC_Payments_Negative" OWNER TO postgres;
GRANT ALL ON TABLE planet."VoC_Payments_Negative" TO postgres;
...
ALTER TABLE planet."VoC_UTF8_Conflicts" OWNER TO postgres;
GRANT ALL ON TABLE planet."VoC_UTF8_Conflicts" TO postgres;
...
ALTER TABLE planet."VoC_clean" OWNER TO postgres;
GRANT ALL ON TABLE planet."VoC_clean" TO postgres;
...
AS SELECT dep.department_name AS "Department",
   ...
   FROM planet.call_performance cp
     ...
     JOIN planet.department dep ON dep.department_id = cp.department_id
  WHERE d."Week_Year" = 2025
  GROUP BY dep.department_name, d."Week_number", d."Date"
  ORDER BY dep.department_name, d."Week_number", d."Date";

-- Permissions

ALTER TABLE planet."WEEKLY_Call_performance" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_Call_performance" TO postgres;
...
ALTER TABLE planet."WEEKLY_Contact_Rate" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_Contact_Rate" TO postgres;
...
ALTER TABLE planet."WEEKLY_Evaluations" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_Evaluations" TO postgres;
...
AS SELECT d."Week_number",
   ...
   FROM planet.incoming_tickets it
     ...
     JOIN planet.department dp ON dp.department_id = it.department_id
  WHERE d."Week_Year" = 2025
  GROUP BY d."Week_number", dp.department_name, d."Date";

-- Permissions

ALTER TABLE planet."WEEKLY_Incoming" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_Incoming" TO postgres;
...
ALTER TABLE planet."WEEKLY_Outbounds" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_Outbounds" TO postgres;
...
ALTER TABLE planet."WEEKLY_Productivity" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_Productivity" TO postgres;
...
ALTER TABLE planet."WEEKLY_RR" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_RR" TO postgres;
...
ALTER TABLE planet."WEEKLY_Tickets_SLA" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_Tickets_SLA" TO postgres;
...
ALTER TABLE planet."WEEKLY_VoC" OWNER TO postgres;
GRANT ALL ON TABLE planet."WEEKLY_VoC" TO postgres;
...
ALTER TABLE planet.contact_per_month OWNER TO postgres;
GRANT ALL ON TABLE planet.contact_per_month TO postgres;
...
ALTER FUNCTION planet._group_concat(text, text) OWNER TO postgres;
GRANT ALL ON FUNCTION planet._group_concat(text, text) TO postgres;
...
ALTER FUNCTION planet.clean_text_fields() OWNER TO postgres;
GRANT ALL ON FUNCTION planet.clean_text_fields() TO postgres;
...
ALTER AGGREGATE planet.group_concat(text) OWNER TO postgres;
GRANT ALL ON AGGREGATE planet.group_concat(text) TO postgres;
...
ALTER FUNCTION planet.immutable_month_name(date) OWNER TO postgres;
GRANT ALL ON FUNCTION planet.immutable_month_name(date) TO postgres;
...
ALTER FUNCTION planet.immutable_month_name(timestamp) OWNER TO postgres;
GRANT ALL ON FUNCTION planet.immutable_month_name(timestamp) TO postgres;
...
ALTER FUNCTION planet.immutable_short_month_name(timestamp) OWNER TO postgres;
GRANT ALL ON FUNCTION planet.immutable_short_month_name(timestamp) TO postgres;
...
ALTER FUNCTION planet.set_month_name() OWNER TO postgres;
GRANT ALL ON FUNCTION planet.set_month_name() TO postgres;
...
ALTER FUNCTION planet.update_date_fields() OWNER TO postgres;
GRANT ALL ON FUNCTION planet.update_date_fields() TO postgres;


-- Permissions

GRANT ALL ON SCHEMA planet TO postgres;
GRANT ALL ON SCHEMA planet TO public;